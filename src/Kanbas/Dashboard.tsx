  ...
  const handleEnrollment = async (courseId: string) => {
    try {
      if (isEnrolled(courseId)) {
        ...
        const enrollment = await enrollmentClient.createEnrollment(
          currentUser._id,
          courseId
        );
        ...
        >
          {displayedCourses.map((course) => (
            <div
              ...
              style={{ width: "270px", padding: "15px" }}
              key={course._id}
            >
              <Link
              ...
              >
                <div className="card rounded-3 overflow-hidden">
                  <img
                    src={`/images/courses/${course.image || "reactjs.jpg"}`}
                  ...
                  <div className="card-body">
                    ...
                    <p
                      className="wd-dashboard-course-title card-text text-muted"
